...
pv_type_actuation c_control_lqrArthur_vel_controller(pv_msg_input inputData){
	...
	printf("K numCols = %d\n",K.numCols);
	printf("K numRows = %d\n",K.numRows);
		printf("%f | %f | %f | %f |\n",*(*(&K.pData + 0) + 0),*(*(&K.pData + 0) + 0),*(*(&K.pData + 0) + 0),*(*(&K.pData + 0) + 0));
		printf("%f | %f | %f | %f |\n",*(*(&K.pData + 0) + 1),*(*(&K.pData + 0) + 1),*(*(&K.pData + 0) + 1),*(*(&K.pData + 0) + 1));
		printf("%f | %f | %f | %f |\n",*(*(&K.pData + 0) + 2),*(*(&K.pData + 0) + 2),*(*(&K.pData + 0) + 2),*(*(&K.pData + 0) + 2));
		printf("%f | %f | %f | %f |\n",*(*(&K.pData + 0) + 3),*(*(&K.pData + 0) + 3),*(*(&K.pData + 0) + 3),*(*(&K.pData + 0) + 3));
	printf("\n----------------------------------------\n");
	...
	printf("\n----------------------------------------\n");
//	printf("equilibrium_control numCols = %d\n",equilibrium_control.numCols);
//	printf("equilibrium_control numRows = %d\n",equilibrium_control.numRows);
//	printf("%f\n",*(*(&equilibrium_control.pData + 0) + 0));
//	printf("%f\n",*(*(&equilibrium_control.pData + 0) + 1));
//	printf("%f\n",*(*(&equilibrium_control.pData + 0) + 2));
//	printf("%f\n",*(*(&equilibrium_control.pData + 0) + 3));
	//
